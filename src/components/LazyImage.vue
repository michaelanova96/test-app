...
// Computed
const srcImage = computed((): string =>
  intersected.value && props.src ? props.src : props.srcPlaceholder
);
const srcsetImage = computed((): string | undefined =>
  intersected.value && props.srcset ? props.srcset : undefined
);
